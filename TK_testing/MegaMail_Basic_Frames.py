...
class App(customtkinter.CTk):
    ...
    def select_frame_by_name(self, name):
        ...
        self.frame_2_button.configure(fg_color=("gray75", "gray25") if name == "Outlook" else "transparent")
        self.frame_3_button.configure(fg_color=("gray75", "gray25") if name == "Gmail" else "transparent")
