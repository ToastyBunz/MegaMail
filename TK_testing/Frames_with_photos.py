...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.home_frame_button_2 = customtkinter.CTkButton(self.home_frame, text="CTkButton", # image=self.image_icon_image,
                                                           compound="right")
        self.home_frame_button_2.grid(row=2, column=0, padx=20, pady=10)
        self.home_frame_button_3 = customtkinter.CTkButton(self.home_frame, text="CTkButton", # image=self.image_icon_image,
                                                           compound="top")
